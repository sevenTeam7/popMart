...
export const reqNews=(page,pageSize)=>ajax.get(`/news/getnewslist?page=${page}&pageSize=${pageSize}`)
//登录
export const reqLogin=(usermail,password)=>ajax.post(`/login/mail`,{usermail,password})